    ...
    def visitTask(self, params):
        ...
        if cube is not None:
            ...
            if measurementy > target_y:
                ...
                print("measurement = x:{:.2f}, y:{:.2f}, target_y={}, output={:.2f} searching {}".format(measurementx, measurementy, target_y, output, color))
            ...
            self.motor.throttle(direction * -0.5, direction * 0.5)
